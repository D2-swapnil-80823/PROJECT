...
public class WebSecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		.authorizeRequests()
				...
				.antMatchers("/cart/**", "/swagger*/**", "/v*/api-docs/**").permitAll() 
				.antMatchers("/cartitem/**", "/swagger*/**", "/v*/api-docs/**").permitAll() 
				.antMatchers("/category/**", "/swagger*/**", "/v*/api-docs/**").permitAll() 
				.antMatchers("/order/**", "/swagger*/**", "/v*/api-docs/**").permitAll() 
				.antMatchers("/products/**", "/swagger*/**", "/v*/api-docs/**").permitAll() 
				.antMatchers("/user/**", "/swagger*/**", "/v*/api-docs/**").permitAll() 
